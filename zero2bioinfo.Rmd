...
# Welcome
You'd like to analyze and visualize your data on a computer. Your workflow will be the most flexible, powerful, and reproducible if it involves *programming*. This type of programming is now called *data science*, and it's hot. In 2018, *data scientist* was the best job in America for the third year in a row according to [Glassdoor](https://www.glassdoor.com/List/Best-Jobs-in-America-LST_KQ0,20.htm). 

Programming looks intimidating, but once you understand the concepts, you should be able to Google questions, understand the answers, and be productive. That's the goal of this tutorial.

Once you decide to program, you need to decide which software to use, so (of course) we'll look at some data. Data scientist job postings on [Indeed](https://www.indeed.com) often include the free languages [R](https://www.r-project.org/) and [Python](https://www.python.org/).
...
In academia, statistical software in Google Scholar papers shows that in 2016 R was the 2nd most used software and is growing. (If you're switching from SAS or SPSS, the author of this analysis also wrote [R for SAS and SPSS Users](http://r4stats.com/books/r4sas-spss/).)

![[The Popularity of Data Science Software, Fig 2d](http://r4stats.com/articles/popularity/)](Fig_2d_ScholarlyImpact2016.png)
...
We have also developed a novel method for Pathway analysis via network smoothing in the [PANTS](https://github.com/jdreyf/PANTS) package. This allows for network-based pathway mediation analysis with `pants_hitman`, which wasn't previously available.
