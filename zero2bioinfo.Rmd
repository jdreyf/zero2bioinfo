...
Once you decide to program, you need to decide which software to use. There's a tremendous amount of software development ongoing in this field, now termed *data science*, particularly in the free languages [R](https://www.r-project.org/) and [Python](https://www.python.org/). In academia, an [analysis](http://r4stats.com/articles/popularity/) of statistical software in Google Scholar papers shows that **R** is currently the 2nd most used software, and is overtaking other languages. (If you're switching from SAS or SPSS, the author of this analysis also wrote [R for SAS and SPSS Users](http://r4stats.com/books/r4sas-spss/).)
