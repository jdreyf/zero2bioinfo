...
# Welcome
You'd like to analyze and visualize your data. Your workflow will be the most flexible, powerful, and reproducible if it involves *programming*. This type of programming is now called *data science*, and it's a [hot field](https://www.glassdoor.com/List/Best-Jobs-in-America-LST_KQ0,20.htm). 
